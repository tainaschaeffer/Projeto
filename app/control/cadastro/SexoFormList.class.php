<?php
/**
 * SexoFormList Form List
 * @author  Tainá Schaeffer 18-06-2018
 */
class SexoFormList extends TPage
{
    protected $form; // form
    ...
    public function __construct( $param )
    {
        ...
        // creates the form
        $this->form = new TQuickForm('form_Sexo');
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            // creates a repository for Sexo
            $repository = new TRepository('Sexo');
            $limit = 10;
            // creates a criteria
            ...
            if (TSession::getValue('Sexo_filter'))
            {
                // add the filter stored in the session to the criteria
                $criteria->add(TSession::getValue('Sexo_filter'));
            }
    ...
    public function Delete($param)
    {
        try
        {
            ...
            $object = new Sexo($key, FALSE); // instantiates the Active Record
    ...
    public function onSave( $param )
    {
        try
        {
            ...
            **/
            ...
            $object = new Sexo;  // create an empty object
    ...
    public function onEdit( $param )
    {
        try
        {
            if (isset($param['key']))
            {
                $key = $param['key'];  // get the parameter $key
                TTransaction::open('permission'); // open a transaction
                $object = new Sexo($key); // instantiates the Active Record
