<?php
/**
 * TipoTelefoneFormList Registration
 * @author  Tainá Schaeffer 18-06-2018
 */
class TipoTelefoneFormList extends TWindow
{
    protected $form; // form
    ...
    public function __construct()
    {
        ...
        $this->setActiveRecord('TipoTelefone');   // defines the active record
        $this->setDefaultOrder('nome', 'asc');         // defines the default order
        // $this->setCriteria($criteria) // define a standard filter
        
        // creates the form
        $this->form = new TQuickForm('form_TipoTelefone');
        $this->form->class = 'tform'; // change CSS class
        $this->form = new BootstrapFormWrapper($this->form);
        $this->form->style = 'display: table;width:100%'; // change style
        $this->form->setFormTitle(_('Tipo telefone'));
        ...
        $container->add(TPanelGroup::pack(_('Tipo telefone'), $this->form));
    ...
    public function Delete($param)
    {
        try
        {
            ...
            $object = new TipoTelefone($key, FALSE); // instantiates the Active Record
    ...
    public function onSave( $param )
    {
        try
        {
            ...
            **/
            ...
            $object = new TipoTelefone;  // create an empty object
    ...
    public function onEdit( $param )
    {
        try
        {
            if (isset($param['key']))
            {
                $key = $param['key'];  // get the parameter $key
                TTransaction::open('permission'); // open a transaction
                $object = new TipoTelefone($key); // instantiates the Active Record
