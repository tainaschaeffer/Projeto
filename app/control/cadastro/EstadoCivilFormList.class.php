<?php
/**
 * EstadoCivilFormList Form List
 * @author  Tainá Schaeffer 18-06-2018
 */
class EstadoCivilFormList extends TWindow
{
    protected $form; // form
    ...
    public function __construct( $param )
    {
        ...
        $container->add(TPanelGroup::pack(_('Estado civil'), $this->form));
    ...
    public function onReload($param = NULL)
    {
        try
        {
            ...
            if (TSession::getValue('EstadoCivil_filter'))
            {
                // add the filter stored in the session to the criteria
                $criteria->add(TSession::getValue('EstadoCivil_filter'));
            }
